...
// Sidebar do artigo individual. Mesmos blocos da sidebar da listagem
// (sidebar.tsx), mas em outra ordem — no print de BLOG - POST.pdf a ordem
// de cima pra baixo é: bio do autor, Mais lidos, card promo, Mais
// relevantes (na listagem é promo, Mais lidos, Mais relevantes, bio).
