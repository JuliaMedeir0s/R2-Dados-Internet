...
export const metadata: Metadata = {
  title: "Política de Privacidade — R2 Internet",
  description:
    "Política de Privacidade da R2 Dados Internet: como coletamos, usamos e protegemos suas informações, e nossa política de cookies.",
};

// Texto portado palavra por palavra de `git show main:src/pages/politica-privacidade.astro`
// (site Astro no ar). Só a marcação mudou: JSX + Tailwind em vez do Astro
// original, sem lib de prose.
export default function PoliticaDePrivacidadePage() {
  return (
    <section className="bg-white py-16">
      <div className="mx-auto max-w-4xl px-4 md:px-8">
        <h1 className="mb-8 text-center text-4xl font-bold text-brand-1 md:text-5xl">
          Políticas de Privacidade
        </h1>

        <div className="space-y-8 text-texto">
          <div>
            ...
            <div className="space-y-4 text-base leading-relaxed">
              <p>
                A sua privacidade é importante para nós. É política da R2
                Dados Internet respeitar a sua privacidade em relação a
                qualquer informação sua que possamos coletar no site
                https://r2dados.com/, e outros sites que possuímos e
                operamos.
              </p>
              <p>
              ...
              <p>
                ...
                para fornecer o serviço solicitado. Quando armazenamos
                dados, os protegemos dentro de meios comercialmente
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-base leading-relaxed">
                  ...
                  este site usa cookies, que são pequenos arquivos baixados
                  no seu computador, para melhorar sua experiência. Esta
                  página descreve quais informações eles coletam, como as
                  usamos e por que às vezes precisamos armazenar esses
                  cookies. Também compartilharemos como você pode impedir
                  que esses cookies sejam armazenados, no entanto, isso pode
                  fazer o downgrade ou &apos;quebrar&apos; certos elementos
              ...
              <div>
                <h3 className="mb-3 text-xl font-bold">Desativar cookies</h3>
                <p className="text-base leading-relaxed">
                  Você pode impedir a configuração de cookies ajustando as
                  configurações do seu navegador (consulte a &quot;Ajuda&quot;
                  do navegador para saber como fazer isso). Esteja ciente de
              ...
              <div>
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <div>
                    ...
                    <p>
                      Se você criar uma conta conosco, usaremos cookies para
                      o gerenciamento do processo de inscrição e
                      administração geral. Esses cookies geralmente são
                      excluídos quando você sair do sistema, porém, em
                      alguns casos, eles poderão permanecer posteriormente
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      possamos lembrar dessa ação. Isso evita que você
                      precise fazer login sempre que visitar uma nova
                      página. Esses cookies são normalmente removidos ou
                      limpos quando você efetua logout para garantir que
                      você possa acessar apenas a recursos e áreas
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      informativo ou e-mail e os cookies podem ser usados
                      para lembrar se você já está registrado e se deve
                      mostrar determinadas notificações válidas apenas para
                      usuários inscritos ou não inscritos.
                    </p>
                  </div>
              ...
              <div>
                <h3 className="mb-3 text-xl font-bold">Alterações no site</h3>
                <p className="text-base leading-relaxed">
                  Periodicamente, testamos novos recursos e fazemos
                  alterações sutis na maneira como o site se apresenta.
          ...
          <div>
            ...
            <p className="mb-4 text-base leading-relaxed">
              ...
              da informação que a R2 Dados Internet oferece no site e com
              caráter enunciativo, mas não limitativo:
            </p>
            <ul className="list-none space-y-3 pl-4 text-base leading-relaxed">
              <li>
                <strong>A)</strong> Não se envolver em atividades que sejam
                ilegais ou contrárias à boa fé a à ordem pública;
              </li>
              <li>
                <strong>B)</strong> Não difundir propaganda ou conteúdo de
                natureza racista, xenofóbica, ou sobre cassinos, apostas
                desportivas (ex.: Betway), jogos de sorte e azar, qualquer
                tipo de pornografia ilegal, de apologia ao terrorismo ou
                contra os direitos humanos;
              </li>
              <li>
                <strong>C)</strong> Não causar danos aos sistemas físicos
                (hardwares) e lógicos (softwares) da R2 Dados Internet, de
